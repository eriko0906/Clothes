...
ActiveRecord::Schema.define(version: 2021_05_31_002548) do
  ...
  create_table "cloths", force: :cascade do |t|
    ...
    t.index ["user_id", "category_id", "created_at"], name: "index_cloths_on_user_id_and_category_id_and_created_at"
